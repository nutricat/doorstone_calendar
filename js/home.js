...
const DIRECTOR_COMMENTS = {
  ...
  // 공기업/공공기관
  '사무직 (일반행정/사무)': '공기업 행정 직무는 한국사 1급이 사실상 필수입니다. 컴활 1급·KBS한국어·한자급수자격도 NCS 서류 가점 항목이므로 조기 취득 전략을 권장합니다.',
  '사무직 (재무/회계)':     '공기업 재무·회계 직무는 재경관리사·전산세무회계가 직무 적합성 지표로 활용됩니다. 한국사 1급은 전형 공통 요구 사항이므로 반드시 선취득하세요.',
